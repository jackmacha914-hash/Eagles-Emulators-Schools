...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchUsers() {
        try {
            const res = await fetch('https://eagles-emulators-schools.onrender.com/api/auth/signup', {
                method: 'GET',
                headers: {
    ...
    async function fetchAccounts() {
        try {
            const res = await authFetch('https://eagles-emulators-schools.onrender.com/api/accounts');
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (clubForm && clubNameInput && advisorInput) {
            clubForm.addEventListener('submit', async (e) => {
                ...
                try {
                    const res = await authFetch('https://eagles-emulators-schools.onrender.com/api/clubs', {
                        method: 'POST',
    ...
    if (eventForm) {
        eventForm.addEventListener('submit', async (e) => {
            ...
            try {
                const res = await authFetch('https://eagles-emulators-schools.onrender.com/api/events', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    document.getElementById('add-teacher-form')?.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await authFetch('https://eagles-emulators-schools.onrender.com/api/users/teachers', {
                method: 'POST',
    ...
    document.getElementById('add-student-form')?.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await authFetch('https://eagles-emulators-schools.onrender.com/api/users/students', {
                method: 'POST',
    ...
    document.getElementById('broadcast-form')?.addEventListener('submit', async function (e) {
        ...
        try {
            const res = await authFetch('https://eagles-emulators-schools.onrender.com/api/broadcast', {
                method: 'POST',
    ...
    document.getElementById('backup-btn')?.addEventListener('click', () => {
        window.location.href = 'https://eagles-emulators-schools.onrender.com/api/backup/download';
    });
