...
class AccountantFees {
    ...
    initialize() {
        ...
        this.tryDeleteFee = async (feeId, token) => {
            ...
            try {
                const deleteUrl = `https://eagles-emulators-schools.onrender.com/api/fees/${feeId}`;
    ...
    async recordPayment(feeId) {
        try {
            ...
            try {
                ...
                const response = await fetch(`https://eagles-emulators-schools.onrender.com/api/fees/${feeId}/payments`, {
                    method: 'POST',
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json',
    ...
    async getFeeById(feeId) {
        try {
            ...
            const response = await fetch(`https://eagles-emulators-schools.onrender.com/api/fees/${feeId}`, {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
