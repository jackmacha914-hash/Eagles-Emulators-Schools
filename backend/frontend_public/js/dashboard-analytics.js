...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    const [userCount, clubCount, bookCount, feeCount, eventCount] = await Promise.all([
        fetchCount('https://eagles-emulators-schools.onrender.com/api/users'),
        fetchCount('https://eagles-emulators-schools.onrender.com/api/clubs'),
        fetchCount('https://eagles-emulators-schools.onrender.com/api/library'),
        fetchCount('https://eagles-emulators-schools.onrender.com/api/fees'),
        fetchCount('https://eagles-emulators-schools.onrender.com/api/events'),
    ]);
