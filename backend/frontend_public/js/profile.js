...
<<<<<<< HEAD
        photoUrl = photoUrl.replace(/^http:\/\/localhost(:\d+)?/, window.API_CONFIG?.BASE_URL || 'https://eagles-emulators-schools.onrender.com');
=======
...
<<<<<<< HEAD
            photoUrl = `${window.API_CONFIG?.BASE_URL || 'https://eagles-emulators-schools.onrender.com'}${data.profile.photo}`;
          } else if (!data.profile.photo.startsWith('http')) {
            photoUrl = `${window.API_CONFIG?.BASE_URL || 'https://eagles-emulators-schools.onrender.com'}/uploads/${data.profile.photo}`;
=======
...
async function changePassword() {
  ...
  try {
<<<<<<< HEAD
    const response = await fetch("https://eagles-emulators-schools.onrender.com/api/profile/change-password", {
=======
